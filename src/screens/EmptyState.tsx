...
export function EmptyState(props: EmptyStateProps) {
  ...
  return (
    <>
      ...
      {/* Main Content Canvas */}
      <main className="flex-1 flex flex-col items-center justify-center p-margin-desktop relative overflow-y-auto min-h-screen bg-background">
        ...
        <div className="relative z-10 flex flex-col items-center text-center max-w-md w-full animate-fade-in-up">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-xl py-lg bg-primary-container text-on-primary-container font-title-sm text-title-sm rounded-lg hover:bg-primary transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background group cursor-pointer"
          >
          ...
          <div className="mt-lg flex items-center gap-4 border-t border-outline-variant pt-lg w-full justify-center">
            <button
              ...
              className="flex items-center gap-1 font-body-sm text-body-sm text-primary hover:text-primary-fixed transition-colors cursor-pointer"
            >
